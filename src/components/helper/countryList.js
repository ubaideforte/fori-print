export const countryOptions = [
  ...
  export const qualificationOptions = [
    { name: "Secondary Certification", value: "Secondary_Certification" },
    { name: "Vocational", value: "Vocational" },
    { name: "Bachelors", value: "Bachelors" },
    { name: "Masters", value: "Masters" },
    { name: "Doctrate", value: "Doctrate" }
  ];

  export const whyJoinEmergeOptions = [
    { name: "To expand my knowledge", value: "To_expand_my_knowledge" },
    { name: "To grow my network", value: "To_grow_my_network" },
    { name: "To contribute towards developing a knowledge society", value: "To_contribute_towards_developing_a_knowledge_society" },
